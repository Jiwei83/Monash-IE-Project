        ...
        filterMarkers = function (category) {
            if (category == 'BBQ') {
                ...
                function windowControl(e, infoWindow, map) {
                    ...
                    infoWindow.setOptions({
                        content: "<a href=http://localhost:8888/map/info.php?lat="  + lat1 + "&lng=" + lng1 + ">" + "show Info" + "</a>",
                        position: e.latLng,
            ...
            if (category == 'Dog Friendly') {
                ...
                function windowControl(e, infoWindow, map) {
                    ...
                    lng2 = e.latLng.lng();
                    infoWindow.setOptions({
                        content: "<a href=http://localhost:8888/map/index.php?lat="  + lat2 + "&lng=" + lng2 + ">" + "show Info" + "</a>",
                        position: e.latLng,
                        pixelOffset: e.pixelOffset
                    });
                    infoWindow.open(map);
            ...
            if (category == 'Drinking Fountains') {
                ...
                function windowControl(e, infoWindow, map) {
                    ...
                    lng3 = e.latLng.lng();
                    infoWindow.setOptions({
                        content: "<a href=http://localhost:8888/map/index.php?lat="  + lat3 + "&lng=" + lng3 + ">" + "show Info" + "</a>",
                        position: e.latLng,
                        pixelOffset: e.pixelOffset
                    });
                    infoWindow.open(map);
            ...
            if (category == 'Information Pillars') {
                layer4 = new google.maps.FusionTablesLayer({
                    query: {
                        select: 'location',
                        from: '14C7aJpcbtibDEwXNoGdZw6iEOu-tzL2CC9wBFFYN',
                    },
                    styles: [{
                        markerOptions: {
                            iconName: "large_red"
                ...
                function windowControl(e, infoWindow, map) {
                    ...
                    lng4 = e.latLng.lng();
                    infoWindow.setOptions({
                        content: "<a href=http://localhost:8888/map/index.php?lat="  + lat4 + "&lng=" + lng4 + ">" + "show Info" + "</a>",
                        position: e.latLng,
                        pixelOffset: e.pixelOffset
                    });
                    infoWindow.open(map);
