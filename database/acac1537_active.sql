...
--
-- Host: localhost:3306
-- Generation Time: May 08, 2016 at 11:17 PM
...
CREATE TABLE IF NOT EXISTS `events` (
  `eventId` int(60) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`eventId`,`create_user_id`)
...
(33, 2, 'fly to the sky', 'lol', 'Yoga', '15 Cambridge St, Maidstone VIC 3012, Australia', 'Maidstone', 14, 1, '2016-05-08 17:00:00', 'active'),
(34, 1, 'fly to the ground', 'lol', 'BBQ', '25 Van Ness Ave, Maribyrnong VIC 3032, Australia', 'Maribyrnong', 2, 2, '2016-05-08 19:00:00', 'active'),
(35, 3, 'walk horses', 'Test Test', 'BBQ', '2 The Crossway, Keilor East VIC 3033, Australia', 'Keilor East', 5, 2, '2014-09-22 20:37:00', 'active');
...
(4, 'tefo', 'tefo@gmail.com', '$2y$10$GKz42uW2CoAjWNEyXWXi0OKGSQUlMvnLIo8RLIFXlE/xh50/E5vmi', '2016-05-08 11:09:26', ''),
(5, 'zoe1', 'zoe1@123.com', '$2y$10$omp7KAe5VZKJ2b8aq1opc.E3jYj3ejXpVXt.05btUvUMAonb5gDUq', '2016-05-08 11:18:29', '');
...
CREATE TABLE IF NOT EXISTS `user_profile` (
  ...
  `subscription` varchar(40) NOT NULL DEFAULT 'subscribed',
  PRIMARY KEY (`user_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6 ;
...
INSERT INTO `user_profile` (`user_id`, `user_fname`, `user_lname`, `dob`, `phone`, `email`, `postcode`, `suburb`, `address`, `family_size`, `interest`, `pet_number`, `subscription`) VALUES
(1, 'kricm', 'ma', '2016-05-05', '123456', '12@11.com', '3145', 'California, United States', 'California, United States', 1, 'BBQ, basketball, ', 1, 'unsubscribed'),
(2, 'zoe', 'huang', '2016-05-06', '1234567890', '1234@qq.com', '3145', 'Caulfield, Victoria, Australia', 'Caulfield, Victoria, Australia', 1, 'BBQ, basketball, pet, ', 1, 'subscribed'),
(3, 'jerry', 'zhang', '0000-00-00', '123456', 'zljerry0724@gmail.com', '3168', 'Caulfield, Victoria, Australia', '900 Dandenong Road, Caulfield East, Victoria, Australia', 1, 'BBQ, basketball, ', 2, 'unsubscribed'),
(4, 'tefo', 'tefo', '0000-00-00', '12345', 'tefo@gmail.com', '1234', 'Caulfield, Victoria, Australia', 'caulf', 1, 'BBQ, basketball, ', 1, 'subscribed'),
(5, 'zoe', 'huang', '0000-00-00', '123456', 'zoe1@123.com', '1234', 'Caulfield, Victoria, Australia', 'Caulfield, Victoria, Australia', 1, 'BBQ, Yoga, ', 1, 'subscribed');
