...
<script src="js/jquery.js"></script>
        <form class="form-signin" method="post" id="login-form">
            ...
            <div class="form-group">
                ...
                <textarea rows="5" cols="52" id="description" placeholder="Please Insert Description" name="description" style="max-width: 100%; border-color: lightgray;" autofocus required="true"><?php echo $desc?></textarea>
                <span id="check-e"></span>
            </div>
            <div class="form-group">
                Hold Date<span>*</span>
